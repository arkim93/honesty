...
Route::group(['prefix'=>'/', 'middleware'=>'auth', 'namespace'=>'Admin'], function() {
    ...
    // Rekening
        Route::resource('rekening', 'RekeningController',['except' => ['create', 'show']]);
        Route::get('rekenings', 'RekeningController@rekenings');
        Route::get('rekeningautokode', 'RekeningController@getAutoCode');
        // Member - end
