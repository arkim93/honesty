...
<div class="row">
    ...
    @endif
        <div class="form-group">
            <label for="harga_jual_1lihat" class="control-label col-sm-4">Harga Reguler: </label>
            <div class="col-sm-8">
...
<div class="row">
    <div class="col-sm-6 form-horizontal">
        <div class="form-group">
            <label for="harga_jual_2lihat" class="control-label col-sm-4">Harga Reseller PKL: </label>
            <div class="col-sm-8">
    ...
    <div class="col-sm-6 form-horizontal">
        <div class="form-group">
            <label for="harga_jual_3lihat" class="control-label col-sm-4">Harga Reseller Luar : </label>
            <div class="col-sm-8">
                <input type="text" nama="harga_jual_3lihat" id="harga_jual_3lihat" value="" class="form-control inputanangka" placeholder="Harga Jual 3" disabled />
            </div>
        </div>
    </div>
</div>