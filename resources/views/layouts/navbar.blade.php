<!-- Collect the nav links, forms, and other content for toggling --> 
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Menu CS <span class="caret"></span></a>
                  ...
                  <li class="dropdown-submenu dropdown-hover">
                    ...
                    <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Barang <span class="caret"></span></a>
                    
                      <ul class="dropdown-menu border-0 shadow" role="menu">
                @if(Auth::user()->can(['lihat_barang']))
                <li><a href="/barang" tabindex="-1">List Barang</a></li>
                @endif
                @if(Auth::user()->can(['lihat_opname']))
                <li><a href="/opname" tabindex="-2">Stok Opname</a></li>
                @endif
                @if(Auth::user()->can(['lihat_jenis']))
                <li><a href="/jenis" tabindex="-3">Jenis Barang</a></li>
                @endif
