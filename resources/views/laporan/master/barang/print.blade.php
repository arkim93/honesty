...
<table id="dataTableBuilder" class="table table-striped table-bordered table-hover display select tg"
    ...
    <tr>
        ...
        <th><strong class="tg-3wr7">Nama</strong></th>
        <th style="width: 15%;" class="tg-3wr7"><strong>Jenis</strong></th>
        <th style="width: 8%;" class="tg-3wr7"><strong>H. Beli</strong></th>
        <th style="width: 8%;" class="tg-3wr7"><strong>Harga 1</strong></th>
        <th style="width: 8%;" class="tg-3wr7"><strong>Harga 2</strong></th>
        <th style="width: 8%;" class="tg-3wr7"><strong>Harga 3</strong></th>
        <th style="width: 5%;" class="tg-3wr7"><strong>Stok</strong></th>
    </tr>
    </thead>
    <tbody>
    @foreach($barang as $i => $value)
        <tr>
            ...
            <td style="width: 15%;" class="tg-rv4w">{{ $value->jenis->nama }}</td>
            <td style="width: 8%; text-align: right;" class="tg-rv4w">{{ number_format($value->harga_beli,0,',', '.') }}</td>
            <td style="width: 8%; text-align: right;" class="tg-rv4w">{{ number_format($value->harga_jual_1,0,',', '.') }}</td>
            <td style="width: 8%; text-align: right;" class="tg-rv4w">{{ number_format($value->harga_jual_2,0,',', '.') }}</td>
            <td style="width: 8%; text-align: right;" class="tg-rv4w">{{ number_format($value->harga_jual_3,0,',', '.') }}</td>
            <td style="width: 5%; text-align: right;" class="tg-rv4w">{{ number_format($value->stok,0,',', '.') }}</td>
        </tr>
    @endforeach
    ...
    <tfoot>
        <tr>
            <th colspan="5" style="text-align: center;" class="tg-3wr7"><strong>Total Stok Barang</strong></th>
            <th style="width: 5%;text-align: right;" class="tg-3wr7"><strong>{{number_format($totalbeli,0,',', '.')}}</strong></th>
            <th style="width: 5%;text-align: right;" class="tg-3wr7"><strong>{{number_format($totaljual1,0,',', '.')}}</strong></th>
            <th style="width: 5%;text-align: right;" class="tg-3wr7"><strong>{{number_format($totaljual2,0,',', '.')}}</strong></th>
            <th style="width: 5%;text-align: right;" class="tg-3wr7"><strong>{{number_format($totaljual3,0,',', '.')}}</strong></th>
            <th style="width: 5%;text-align: right;" class="tg-3wr7"><strong>{{number_format($total,0,',', '.')}}</strong></th>
        </tr>
    </tfoot>
</table>
