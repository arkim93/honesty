                   ...
                   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTableBuilder">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <label for="disc" class="control-label col-sm-4">Discount: </label>
                                        <div class="col-sm-8">
                                            <input type="text" name="disc" id="disc" value="{{ number_format($penjualan->discount, 0, '.', ',') }}" class="form-control i" placeholder="Discount" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
