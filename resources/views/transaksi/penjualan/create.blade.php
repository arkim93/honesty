              ...
              <div class="row">
                <div class="col-sm-12 form-horizontal form-left">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="infokode" id="infokode" value="" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                <hr />
                   ...
                   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTableBuilder">
                          ...
                          <div class="row">
                            <div class="col-sm-6 form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        {!! Form::textarea('catatan',null,['id'=>'catatan', 'class'=>'form-control', 'rows'=>3, 'placeholder'=>'Catatan tambahan (jika ada)']) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="disc" id="disc" value="" class="form-control " placeholder="Discount" disabled />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="bayar" id="bayar" value="" class="form-control inputanangka inputbayarkembali" placeholder="Bayar" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="kembali" id="kembali" value="" class="form-control inputbayarkembali" placeholder="Uang Kembalian" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('custom_script_footer')
    <script src="/js/transaksi/penjualan/create.js"></script>
@endsection
