<div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 controls">
                <div class="input-group">
                    <input type="text" name="barang" id="barang" value="" class="form-control" placeholder="Kode Barang" />
                    <span class="input-group-btn">
                        <a class="btn btn-default" type="button" data-toggle="modal" data-target="#modalCari" id="caribarang" onClick="CariClick(this);">
    ...
    <div class="col-sm-12 form-horizontal form-left">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="harga_beli" value="" id="harga_beli" class="form-control inputanangka" required />
            </div>
        </div>
    </div>
    <div class="col-sm-12 form-horizontal form-left">
